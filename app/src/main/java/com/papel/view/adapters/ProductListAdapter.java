...
public class ProductListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            viewHolder.txtPrice = convertView.findViewById(R.id.etlPriceProduct);
            viewHolder.txtQuantity = convertView.findViewById(R.id.etlQuantityProduct);
        ...
        viewHolder.txtPrice.setText(String.valueOf("Price: "+String.valueOf(product.getPrice())));
        viewHolder.txtQuantity.setText(String.valueOf("Quantity: "+String.valueOf(product.getQuantity())));
